...
| Which scheduling software will Maddie use for cross-platform publishing? (decides shape of Cross-Platform Repurposer skill.) | Tom + Maddie | **Resolved 28 May.** Metricool. Trialling Advanced plan first; MCP integration follows if trial confirms fit. Move to Resolved. | 2026-05-28 | 2026-05-18 (Maddie OS scaffold) | Resolved |
| Metricool MCP setup for all 3 brands (Fade Golf, Stride, F&E Leamington). Until this lands, Data Pull skill is a stub and weekly/monthly reports run without Metricool data. | Tom + Maddie | Trial agreed 28 May. Maddie starting Advanced trial to test scheduling. OAuth for 3 brands + MCP integration to follow once trial confirms fit. | TBC -- after trial | 2026-05-18 (Maddie OS scaffold) | In Progress |
...
| Confirm ongoing partnership scope with Padel + Play beyond June pop-up (referrals, future events, content crossover). | Tom + Harry + Manny | Immediate event scope confirmed: F&E therapist pop-up at Padel + Play courts, Stratford, 12 June. Ongoing scope (recurring events, referral arrangement, content) still TBC with Manny. | TBC | 2026-05-22 | Open |

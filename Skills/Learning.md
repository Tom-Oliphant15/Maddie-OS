...
- `Information/Open Questions.md` for state on unresolved follow-ups so we don't re-ask things already parked
...
2. **Complete reinstall or manual full audit.** Maddie can call `/learning` directly any time she wants a structured pass over the whole Brain, but this is rare. Day to day, the OS picks up Brain changes via the Live Brain Update rule in `Instructions.md`.

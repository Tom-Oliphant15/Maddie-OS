...
Public key below, repo is tomoliphant/maddie-os.
...
```
Expected output contains: `Hi tomoliphant/maddie-os!` (or similar repo acknowledgement).
...
```bash
cd "$HOME/Documents"
git clone git@github.com-maddie-os:tomoliphant/maddie-os.git "Maddie OS"
```
